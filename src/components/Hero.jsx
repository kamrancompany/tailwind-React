...
const Hero = () => {
  return (
    <section
      id="home"
      className={`flex flex-col sm:flex-row ${styles.paddingY} `}
    >
      <div
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-[100px] leading-[75px]">
            ...
            <span className="text-gradient">Genaration</span>
          </h1>
      ...
      >
        ...
        <div className="absolute z-[0] w-[50%] h-[50%] tright-20 bottom-20  blue__gradient" />
      </div>
